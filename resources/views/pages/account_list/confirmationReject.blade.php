    ...
    <form action="/account_requests/approval/{{ $item->id }}" method="post">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title fs-5" id="confirmationRejectLabel">Konfirmasi Non-aktif akun</h4>
          ...
          <div class="modal-body">
            ...
            <span>Apakah anda yakin untuk mennonaktifkan akun ini?</span>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
            <button type="submit" class="btn btn-outline-danger">Iya, non-aktifkan!</button>
          </div>
        </div>
    </form>
  </div>
